...
import com.example.admin_e_commerce.model.Admins
import com.example.admin_e_commerce.Utils
import com.example.admin_e_commerce.databinding.FragmentOTPBinding
...
class OTPFragment : Fragment() {
    ...
    private fun verify0tp(otp: String) {
        val admins= Admins(uid=null, userPhoneNumber = userNumber)
